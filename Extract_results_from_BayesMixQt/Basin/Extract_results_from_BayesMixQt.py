...
names_txt.sort()
date = '3_9'  # set the date on the file name for easy finding.
writer_map = pd.ExcelWriter('basin_map_'+date+'.xlsx')

#read Zircon U-Pb data
Data_mixed_rivers = pd.read_excel('basin_use_op_2021_2_25.xlsx',sheet_name = None)
#===================== read file end =========================================
